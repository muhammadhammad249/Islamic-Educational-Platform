            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2 group relative">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <Link href="#" className="font-sans text-[10px] uppercase font-bold text-white/40 hover:text-white transition-colors">
                    {t('forgot')}
                  </Link>
                </div>
                <div className="relative">
                  <input 
                    ...
                    required
                    className="w-full bg-[#0D0D0D]/40 border-b border-accent/25 focus:border-accent text-white pl-4 pr-12 py-3 focus:bg-[#0D0D0D]/60 outline-none font-sans transition-all duration-300 rounded-t-lg"
                    placeholder="••••••••"
                  />
