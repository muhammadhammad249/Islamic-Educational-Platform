...
const SUPPORT_EMAIL = 'support@al-madrasa.com';
...
const IslamicPattern = ({ className = '' }: { className?: string }) => (
  ...
  >
    ...
    <rect width="100" height="100" fill="url(#contactIslamicGrid)" />
  </svg>
);
        ...
        <section className="text-center mb-16 sm:mb-20 max-w-2xl mx-auto relative z-10">
          <AnimateIn direction="down">
            ...
            <div className="flex justify-center items-center gap-3 mb-6">
              ...
              <span className="material-symbols-outlined text-accent text-xs select-none">
                star
              </span>
                ...
                >
                  ...
                  <div className="space-y-2 group">
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#0D0D0D]/40 border-b border-accent/25 focus:border-accent text-white px-4 py-3 focus:bg-[#0D0D0D]/60 outline-none font-sans transition-all duration-300 rounded-t-lg resize-none placeholder:text-white/25"
                    />
                  </div>
