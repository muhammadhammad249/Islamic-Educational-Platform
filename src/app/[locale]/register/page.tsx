      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <AnimateIn direction="down">
            <Link
              href="/"
              className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-accent text-primary font-black text-xl mb-5"
            >
              A
            </Link>
        ...
        <AnimateIn direction="up" delay={0.1}>
          <form
            ...
            className="space-y-5 bg-gradient-to-br from-[#1C1C1C]/60 to-[#0F0F0F]/85 backdrop-blur-xl border border-accent/15 p-8 sm:p-10 rounded-3xl shadow-2xl shadow-black/40"
          >
            <div className="space-y-4">
              <div className="space-y-1.5 group">
                ...
                <input
                  ...
                  className="w-full bg-[#0D0D0D]/40 border-b border-accent/25 focus:border-accent text-white px-4 py-2.5 focus:bg-[#0D0D0D]/60 outline-none font-sans transition-all duration-300 rounded-t-lg text-sm placeholder:text-white/25"
              ...
              <div className="space-y-1.5 group relative">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-[#0D0D0D]/40 border-b border-accent/25 focus:border-accent text-white pl-4 pr-12 py-2.5 focus:bg-[#0D0D0D]/60 outline-none font-sans transition-all duration-300 rounded-t-lg text-sm placeholder:text-white/25"
                    placeholder="••••••••"
                  />
